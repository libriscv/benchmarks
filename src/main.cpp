...
int main()
{
	...
	run_test("luajit: integer math", S, test_setup, test_3_lua_math1);
	run_test("luajit: fp math", S, test_setup, test_3_lua_math2);
	run_test("luajit: exp math", S, test_setup, test_3_lua_math3);
	printf("\n");
